...
abbrev: mud-iot-dns
docname: draft-ietf-opsawg-mud-iot-dns-considerations-08
...
Whether this is restricted to Classic DNS (Do53) or also includes using DoT/DoH is a local decision, but a locally provided DoT server SHOULD be used, as recommended by {{?I-D.reddy-add-iot-byod-bootstrap}}.
